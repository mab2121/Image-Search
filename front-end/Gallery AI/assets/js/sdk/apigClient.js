...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://dv6y6hkmd4.execute-api.us-east-1.amazonaws.com/Dev';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'Access-Control-Allow-Headers', 'x-amz-meta-customLabels'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type', 'Access-Control-Allow-Headers', 'x-amz-meta-customLabels']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
